...
ActiveRecord::Schema[8.1].define(version: 2026_07_01_020000) do
  ...
  create_table 'digest_subscriptions', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index 'lower((email)::text)',
            name: 'index_digest_subscriptions_on_lower_email',
            unique: true
  end
  ...
  create_table 'payments', force: :cascade do |t|
    ...
    t.index ['stripe_session_id'],
            name: 'index_payments_on_stripe_session_id',
            unique: true
  ...
  create_table 'votes', force: :cascade do |t|
    ...
    t.index %w[user_id entry_id],
            name: 'index_votes_on_user_id_and_entry_id',
            unique: true
