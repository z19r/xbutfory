...
export default class extends Controller {
  ...
  copy() {
    navigator.clipboard.writeText(COUPON_CODE).then(() => {
      document.dispatchEvent(new CustomEvent("toast:show", { detail: { message: "📋 Copied to clipboard." } }))
    })
  }
  ...
  startFireworks() {
    ...
    const particles = []
    const colors = ["#E11D8F", "#C93B1B", "#D98A2B", "#2E8B8B", "#3A6EA5", "#6A3D9E", "#F3EDE3"]
    ...
    tick()
    setTimeout(() => { this._fwLaunching = false }, 3000)
  }
