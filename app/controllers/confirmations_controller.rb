class ConfirmationsController < ApplicationController
  ...
  def create
    UserMailer.confirmation(current_user).deliver_later if current_user && !current_user.confirmed?
    redirect_back fallback_location: root_path, notice: "Confirmation email on its way."
  end
end
