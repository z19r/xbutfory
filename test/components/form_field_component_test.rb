...
class FormFieldComponentTest < ViewComponent::TestCase
  test 'renders a labeled input' do
    render_inline(
      FormFieldComponent.new(label: 'Email', name: 'email', type: 'email'),
    )
  ...
  test 'renders a prefix and marks the input prefixed' do
    render_inline(
      FormFieldComponent.new(label: 'Handle', name: 'handle', prefix: '@'),
    )
  ...
  test 'renders trailing and label_aside slots' do
    render_inline(
      FormFieldComponent.new(label: 'Password', name: 'password'),
    ) do |f|
  ...
  test 'mono adds the mono modifier' do
    render_inline(
      FormFieldComponent.new(label: 'Handle', name: 'handle', mono: true),
    )
