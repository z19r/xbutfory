Rails.application.routes.draw do
  ...
  resources :submissions, only: %i[create edit update]
  patch 'submissions/:id/status',
        to: 'submissions#transition',
  ...
  get 'digest/unsubscribe/:token',
      to: 'digest_subscriptions#destroy',
      as: :digest_unsubscribe
  ...
  patch 'account/security',
        to: 'accounts#update_security',
        as: :account_security
  patch 'account/notifications',
        to: 'accounts#update_notifications',
        as: :account_notifications
  post 'account/api_key',
       to: 'accounts#regenerate_api_key',
       as: :account_api_key
